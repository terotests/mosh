...
- [_enterCtx](README.md#callContext__enterCtx)
- [_getCtx](README.md#callContext__getCtx)
- [_leaveCtx](README.md#callContext__leaveCtx)
- [_resetCtx](README.md#callContext__resetCtx)
- [_setCtx](README.md#callContext__setCtx)
...
- [_askSnapshot](README.md#commad_trait__askSnapshot)
- [_broadcastToCmdChannels](README.md#commad_trait__broadcastToCmdChannels)
- [_clearCmdCache](README.md#commad_trait__clearCmdCache)
- [_removeFromCache](README.md#commad_trait__removeFromCache)
- [_sendToInListeners](README.md#commad_trait__sendToInListeners)
- [addToCache](README.md#commad_trait_addToCache)
- [execCommands](README.md#commad_trait_execCommands)
- [findFromCache](README.md#commad_trait_findFromCache)
- [getObjectCache](README.md#commad_trait_getObjectCache)
- [isRecordingCommands](README.md#commad_trait_isRecordingCommands)
- [saveCommand](README.md#commad_trait_saveCommand)
- [setCommandRecOnOff](README.md#commad_trait_setCommandRecOnOff)
...
### <a name="callContext__enterCtx"></a>callContext::_enterCtx(fname)
...
### <a name="callContext__getCtx"></a>callContext::_getCtx(t)


```javascript
var o = {}, a = _callContext.active;
for(var n in a) {
...
### <a name="callContext__leaveCtx"></a>callContext::_leaveCtx(fname)
...
### <a name="callContext__resetCtx"></a>callContext::_resetCtx(t)
...
### <a name="callContext__setCtx"></a>callContext::_setCtx(ctx)
...
### <a name="commad_trait__askSnapshot"></a>commad_trait::_askSnapshot(bUseRawData)
...
### <a name="commad_trait__broadcastToCmdChannels"></a>commad_trait::_broadcastToCmdChannels(cmdList)
...
### <a name="commad_trait__clearCmdCache"></a>commad_trait::_clearCmdCache(t)
...
### <a name="commad_trait__removeFromCache"></a>commad_trait::_removeFromCache(obj)
...
### <a name="commad_trait__sendToInListeners"></a>commad_trait::_sendToInListeners(data)
...
### <a name="commad_trait_addToCache"></a>commad_trait::addToCache(id, obj)
...
### <a name="commad_trait_execCommands"></a>commad_trait::execCommands(cmdList)
...
### <a name="commad_trait_findFromCache"></a>commad_trait::findFromCache(guid)
...
### <a name="commad_trait_getObjectCache"></a>commad_trait::getObjectCache(t)
...
### <a name="commad_trait_isRecordingCommands"></a>commad_trait::isRecordingCommands(t)
...
### <a name="commad_trait_saveCommand"></a>commad_trait::saveCommand(action, property, value, oldValue)
...
### <a name="commad_trait_setCommandRecOnOff"></a>commad_trait::setCommandRecOnOff(b)
